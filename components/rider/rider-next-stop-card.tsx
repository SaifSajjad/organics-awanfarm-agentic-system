...
export function RiderNextStopCard({ stop, onViewDetails, onContinueRoute }: RiderNextStopCardProps) {
  return (
    <section className="rounded-2xl bg-[#1b4332] p-5 text-white shadow-[0_12px_28px_rgba(27,67,50,0.16)] sm:p-6 lg:p-5 xl:p-6">
      <div className="flex items-start justify-between gap-3">
        <div>
          <p className="text-xs font-black tracking-[0.12em] text-[#a5d0b9]">Next Stop</p>
          <h2 className="mt-1 font-display text-3xl font-black leading-tight lg:text-[2rem]">
      ...
      <div className="mt-5 border-t border-white/20 pt-5">
        <h3 className="text-2xl font-black leading-tight lg:text-[1.7rem]">{stop.customerName}</h3>
      ...
      <p className="mt-4 flex items-center justify-center gap-2 text-sm font-black text-[#c1ecd4]">
