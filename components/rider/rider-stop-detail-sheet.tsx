...
export function RiderStopDetailSheet({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-black/60 px-0 sm:px-6">
      <div
        ref={dialogRef}
        role="dialog"
        aria-modal="true"
        aria-labelledby="rider-stop-detail-title"
        className="max-h-[92vh] w-full max-w-2xl overflow-y-auto rounded-t-[2rem] bg-[#fbf9f4] shadow-[0_-18px_70px_rgba(14,36,25,0.22)] outline-none sm:rounded-t-[2rem]"
        tabIndex={-1}
      >
        <div className="sticky top-0 z-10 border-b border-[#c1c8c2] bg-[#fbf9f4] px-5 pb-4 pt-3 sm:px-8">
          ...
          <div className="mt-5 flex items-center justify-between gap-4">
            <div>
              ...
              <h2 id="rider-stop-detail-title" className="mt-2 font-display text-3xl font-black text-[#012d1d]">
                Stop Details
              </h2>
              <p className="mt-1 text-xl text-[#414844]">Stop {stop.sequence} of 12</p>
            </div>
            <button
              type="button"
              onClick={onClose}
        ...
        <div className="space-y-5 px-5 py-6 sm:px-8">
          <section className="rounded-2xl border border-[#c1c8c2] bg-white p-5">
            <p className="text-sm font-black tracking-[0.12em] text-[#717973]">Customer</p>
            <div className="mt-3">
              <h3 className="text-3xl font-black leading-tight text-[#1b1c19]">{stop.customerName}</h3>
              <p className="mt-1 text-xl text-[#414844]">{stop.area}</p>
            </div>
            ...
            <div className="mt-6 grid gap-2">
              ...
              <p className="text-xl leading-7 text-[#1b1c19]">{stop.address}</p>
            </div>

            <div className="mt-5 rounded-2xl border-l-4 border-[#012d1d] bg-[#f0eee9] p-4">
              <p className="flex items-center gap-2 text-sm font-black tracking-[0.12em] text-[#012d1d]">
                <Info className="h-5 w-5" aria-hidden="true" />
                Access Note
              </p>
              <p className="mt-2 text-lg italic leading-7 text-[#1b1c19]">{stop.accessNote}</p>
            </div>
          </section>
          ...
          <section className="rounded-2xl border border-[#c1c8c2] bg-white p-5">
            ...
            <div className="mt-4 flex flex-wrap items-center justify-between gap-3">
              <p className="text-2xl font-black text-[#012d1d]">{stop.order}</p>
        ...
        <div className="sticky bottom-0 z-10 grid gap-3 border-t border-[#c1c8c2] bg-[#fbf9f4] px-5 py-5 sm:px-8">
          <button
            type="button"
