...
export function RiderDeliveredSuccess({ onContinueRoute }: RiderDeliveredSuccessProps) {
  return (
    <section className="mx-auto grid max-w-xl gap-6 rounded-2xl border border-[#d8d5ca] bg-white p-6 text-center shadow-[0_4px_20px_rgba(27,67,50,0.06)] sm:p-8">
      ...
      <div>
        ...
        <p className="mt-5 text-2xl font-black text-[#1b1c19]">Fatima B.</p>
        <p className="mt-1 text-lg text-[#414844]">Johar Town</p>
        <p className="mt-5 text-base leading-7 text-[#414844]">
